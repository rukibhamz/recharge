    ...
    <div className="flex min-h-screen flex-col bg-warm">
      ...
      <div className="mx-auto w-full max-w-landing flex-1 px-margin-mobile pb-12 pt-6 sm:px-gutter lg:px-8">
        ...
        <SplitEditorialLayout
          ...
          asideBadge="Before burnout"
          asideTitle="Your personality shapes what comes next"
          asideText="The burnout check-in that follows is written with your energy style, decision patterns, and social needs in mind."
        >
          ...
          {personality.summary ? (
            <p className="mt-6 text-center font-sans text-body-md leading-relaxed text-on-surface-variant lg:text-left">
              {personality.summary}
            </p>
          ) : null}
